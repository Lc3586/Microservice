...
var JWTHelper = (function () {
    ...
    JWTHelper.prototype.init = function (renderData, axios, headers) {
    ...
    JWTHelper.prototype.createAxiosInstance = function () {
    ...
    JWTHelper.prototype.addLoginFilter = function (axiosInstance, validationFailed) {
    ...
    JWTHelper.prototype.authorized = function () {
        return __awaiter(this, void 0, void 0, function () {
            var promise;
            var _this = this;
            return __generator(this, function (_a) {
                promise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        this.AxiosInstance.post(ApiUri.JWTAuthorized).then(function (response) {
    ...
    JWTHelper.prototype.getToken = function (refresh) {
            ...
            return __generator(this, function (_a) {
                promise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        this.AxiosInstance.post(ApiUri.GetToken, data).then(function (response) {
                            if (response.data.Success) {
                                ...
                                if (refresh)
                                    setTimeout(function () {
                                        _this.refreshToken(true).then();
                                    }, new Date(_this.Token.Expires).getTime() - new Date().getTime() - 60 * 1000);
                                resolve(_this.Token);
                            }
                            else
    ...
    JWTHelper.prototype.refreshToken = function (refresh) {
        if (refresh === void 0) { refresh = false; }
        return __awaiter(this, void 0, void 0, function () {
            var promise;
            var _this = this;
            return __generator(this, function (_a) {
                promise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        this.AxiosInstance.post(ApiUri.RefreshToken).then(function (response) {
                            if (response.data.Success) {
                                _this.Token = response.data.Data;
                                if (refresh)
                                    setTimeout(function () {
