    ...
    window.importFile(
        ...
        () => {
            let open = (name, e) => {
                window.showDialog(
                    '文件上传',
                    [['iframe', window.baseUri + '/plug-in/naiveupload/index.html']],
                    {
                        '刷新': {
                            'click': () => {
