    ...
    window.importFile(
        ...
        () => {
            var open = (name, e) => {
                window.showDialog(
                    '系统控制台',
                    [['iframe', '/plug-in/systemconsole/systemconsole.html']],
                    {
                        '刷新': {
                            'click': () => {
