...
namespace Api.Controllers
{
    ...
    public class OperationRecordController : BaseApiController
    {
        ...
        {
            return await Task.FromResult(OpenApiJsonContent(OperationRecordBusiness.GetList(pagination), pagination));
        }
        ...
        {
            return await Task.FromResult(OpenApiJsonContent(ResponseDataFactory.Success(OperationRecordBusiness.GetDetail(id))));
        }
