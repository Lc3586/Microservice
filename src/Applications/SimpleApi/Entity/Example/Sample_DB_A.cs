...
namespace Entity.Example
{
    ...
    [OraclePrimaryKeyName("pk_S_DB_A")]
    //[System.ComponentModel.DataAnnotations.Schema.Table(nameof(Example_DB_A))]//特别指定数据库表名
    #region 设置索引
    [Index("S_DB_A_idx_01", nameof(Name) + " ASC")]
    [Index("S_DB_A_idx_02", nameof(CreatorId) + " ASC")]
    [Index("S_DB_A_idx_03", nameof(CreatorName) + " ASC")]
    [Index("S_DB_A_idx_04", nameof(CreateTime) + " DESC")]
    #endregion
    public class Sample_DB_A
    {
        /// <summary>
        /// Id
        /// </summary>
        ...
        [JsonIgnore]
        [XmlIgnore]
        public virtual Sample_DB_A Parent { get; set; }
        ...
        [JsonIgnore]
        [XmlIgnore]
        public virtual ICollection<Sample_DB_A> Childs { get; set; }//virtual ICollection和懒加载配合使用
        ...
        [JsonIgnore]
        [XmlIgnore]
        public virtual Sample_DB_B Example_DB_B { get; set; }
        ...
        [JsonIgnore]
        [XmlIgnore]
        public virtual ICollection<Sample_DB_C> Example_DB_Cs { get; set; }

        /// <summary>
        /// 相关D
        /// </summary>
        /// <remarks>一对多</remarks>
        [Navigate(nameof(Sample_DB_D.AId))]
        [OpenApiIgnore]
        [JsonIgnore]
        [XmlIgnore]
        public virtual ICollection<Sample_DB_D> Example_DB_Ds { get; set; }
