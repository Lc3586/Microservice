...
namespace Entity.System
{
    ...
    [Index("S_M_idx_06", nameof(Method) + " ASC")]
    [Index("S_M_idx_07", nameof(Enable) + " DESC")]
    [Index("S_M_idx_08", nameof(CreatorId) + " ASC")]
    [Index("S_M_idx_09", nameof(CreateTime) + " DESC")]
    [Index("S_M_idx_10", nameof(ModifyTime) + " DESC")]
    #endregion
