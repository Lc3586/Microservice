...
namespace Net5TC.Entity
{
    ...
    [OraclePrimaryKeyName("pk_" + nameof(Example_DB_B))]
    //[System.ComponentModel.DataAnnotations.Schema.Table(nameof(Example_DB_B))]//特别指定数据库表名
    #region 设置索引
    [Index(nameof(Example_DB_B) + "_idx_" + nameof(Name), nameof(Name) + " ASC")]
    [Index(nameof(Example_DB_B) + "_idx_" + nameof(CreatorId), nameof(CreatorId) + " ASC")]
    [Index(nameof(Example_DB_B) + "_idx_" + nameof(CreatorName), nameof(CreatorName) + " ASC")]
    [Index(nameof(Example_DB_B) + "_idx_" + nameof(CreateTime), nameof(CreateTime) + " DESC")]
    #endregion
    public class Example_DB_B
    {
        /// <summary>
        /// Id
        /// </summary>
        ...
        /// </summary>
        /// <remarks>一对多</remarks>
        [Navigate(nameof(Example_DB_A.BId))]
        [OpenApiIgnore]
        [JsonIgnore]
        [XmlIgnore]
